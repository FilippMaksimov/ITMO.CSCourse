...
class CreateAccount
{
    static void Main()
    {
        ...
        acc1.Holder = "Sid"; //NAMES OF THE ACCOUNT HOLDERS
        acc2.Holder = "Ted";

        Console.WriteLine("Account number is {0}, Account Type is {1}", acc1.Number, acc1.Type); // THE NUMBER AND TYPE OF EACH ACCOUNT
